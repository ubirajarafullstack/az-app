    ...
    <>
      <div className="relative h-screen flex justify-center items-center">
                            ...
                            <div className="w-11/12 flex flex-col lg:flex-row-reverse">
                              ...
                              <div className="w-full h-96 sm:h-[484px] gap-4 flex lg:w-7/12">
                                ...
                                <div className="relative w-10/12">
                                  ...
                                  <Link href={`/products/detail/${edge.node.slug}`} className="more-button absolute z-10 -bottom-12 -right-12 m-4 inline-block px-3 py-2 rounded-md bg-white hover:drop-shadow text-sm font-semibold text-black shadow-sm drop-shadow-2xl">Go</Link>
                                </div>
                              ...
                              <div className="info w-10/12 lg:w-5/12">
                                ...
                                <Link href={`/products/detail/${edge.node.slug}`} className="more-button m-4 inline-block px-3 py-2 rounded-md bg-white hover:drop-shadow text-sm font-semibold text-black shadow-sm drop-shadow-2xl">More</Link>
                              </div>
        ...
        <div className="absolute z-20 bottom-0 left-0 p-6 flex flex-col w-full">
          <button
            className="loading-more-button self-center justify-self-center flex items-center justify-center px-3 py-2 rounded-md bg-white hover:drop-shadow font-semibold text-black text-sm shadow-sm drop-shadow-2xl"
            onClick={() => {
              fetchNextPage();
              //setMainContainer([])
              setGalleryContainer([])
